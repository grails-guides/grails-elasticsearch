...
----
include::{sourceDir}/src/integration-test/groovy/demo/BookFunctionalSpec.groovy[indent=0, lines=1..43]
include::{sourceDir}/src/integration-test/groovy/demo/BookFunctionalSpec.groovy[indent=0, lines=153..171]
----